...
import com.lucky.utils.exception.MethodParamObtainException;
...
import org.luckyframework.aop.proxy.AopAdviceChainInvocation;
...
public class MethodInterceptorJoinPoint implements ProceedingJoinPoint, JoinPoint.StaticPart{
    ...
    @NonNull
    private AopAdviceChainInvocation aopAdviceChainInvocation;
    ...
    public Object proceed(Object[] arguments) throws Throwable {
        this.aopAdviceChainInvocation.setArgument(arguments);
    ...
    private class MethodSignatureImpl implements MethodSignature {
        ...
        public String[] getParameterNames() {
            ...
            if (parameterNames == null) {
                try {
                    parameterNames = ArrayUtils.listToArray(ASMUtil.getClassOrInterfaceMethodParamNames(getMethod()));
                } catch (IOException e) {
